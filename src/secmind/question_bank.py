...
class QuestionBankService:
    def __init__(self, settings: Settings, gateway: QwenGateway | None = None) -> None:
    ...
    def _lift_single_branch_root(root: str, directories: set[str], file_paths: list[str]) -> str:
        """Lift a leaf selected by a model to the nearest objective branch boundary."""
