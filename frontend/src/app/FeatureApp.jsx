...
export function FeatureApp() {
  ...
  const items = useMemo(() => [
    { type: 'group', label: '安全运营', children: [
      { key: '/cockpit', icon: <DashboardOutlined />, label: '安全运营驾驶舱' },
