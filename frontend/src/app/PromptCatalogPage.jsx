...
export function PromptCatalogPage() {
  ...
  return <div className="catalog-page">
    <section className="page-intro catalog-hero"><div><Text className="panel-kicker">PROMPT CATALOG / LOCAL IMPORT</Text><Title level={2}>Prompt 目录</Title><p>集中查看已登记的角色 Prompt、来源与校验信息。目录只读，当前不接入 AI 思考流程。</p></div><div className="intro-tags"><Tag color="gold"><LockOutlined /> 运行时未注入</Tag><Button type="text" icon={<ReloadOutlined />} onClick={load}>刷新</Button></div></section>
    <section className="catalog-metrics"><div className="catalog-metric"><FileTextOutlined /><Statistic title="已登记模板" value={data?.count ?? 0} /></div><div className="catalog-metric"><CheckCircleOutlined /><Statistic title="来源" value="本地目录" /></div><div className="catalog-metric"><LockOutlined /><Statistic title="运行时注入" value="否" /></div></section>
